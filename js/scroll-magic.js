$(document).ready(function () {
    ...
    /** Parallax Scrolling for Web Only: */
    if (!isMobile) {
    ...
    /** Function to compute initial stroke amounts for stroke-based effects: */
    ...
    var tween = new TimelineMax()
        ...
        .add(TweenMax.to("path", 0.5, {fill: "#fff", ease:Linear.easeNone}), 0)			// change color during the whole thing
        .add(TweenMax.to("path", 0.5, {transform: 'scale(0.6)', ease:Linear.easeNone}), 0);			// change color during the whole thing

    // build scene
    var scene = new ScrollMagic.Scene({triggerElement: "#header", duration: 200, tweenChanges: true})
        .setTween(tween)
